...
SECRET_KEY = 'u06khfuvyksoz3ot-=p&_+1&atr^8v#7ab-thc8ar)es@=)wwn'
...
# собрать всю статику в единое место, со всех папок статик  наших приложений
...
EMAIL_PORT = 465
EMAIL_HOST_USER = 'liz.pleshkova@yandex.by'#'pl.1.el.vas@gmail.com'
EMAIL_HOST_PASSWORD = '01004020yandex.by'
EMAIL_USE_SSL = True
SERVER_EMAIL = EMAIL_HOST_USER
DEFAULT_FROM_EMAIL = EMAIL_HOST_USER

# for ckeditor
CKEDITOR_UPLOAD_PATH = 'uploads/'# куда будет загружать изображение\ визуальный редактор с возможностью загрузки изображений
